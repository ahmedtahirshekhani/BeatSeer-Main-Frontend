...
export default function Header() {
  return (
    ...
    <header className="bg-[#1d374c] text-white w-[90%] max-w-[800px] top-0 z-50 shadow-md h-30 md:h-40 flex items-center justify-center overflow-hidden mx-auto pb-2">
      <nav className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center text-center max-w-xs md:max-w-none mx-auto">
          ...
          <img src="/images/logoWithName.png" alt="BeatSeer Logo" className="h-20 md:h-20 p-2" />
